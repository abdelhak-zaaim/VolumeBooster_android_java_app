...
public class Knob extends View {
 ...
 void paintKnob(Canvas canvas) {
   ...
   /* public void paintKnob(Canvas canvas) {
        Drawable drawable;
    ...
    void setIndicatorAngleWithDirection() {
        ...
        double angleCurr = normalizeAngle(currentAngle);  //spring.getCurrentValue());
 ...
 */
    ...
    private TouchUpHandler mOnTouchUpHandler=null;

    public void setOnTouchUpListener(TouchUpHandler aHandler){
        mOnTouchUpHandler=aHandler;
    }
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (swipeDirection == SWIPEDIRECTION_VERTICAL) {  // vertical
                    ...
                    if (action == MotionEvent.ACTION_DOWN) {
                        ...
                        if (mOnTouchUpHandler!=null){mOnTouchUpHandler.onUp();}
 ...
 */
    ...
    void setEndAngle(double aNewAngle){
    ...
    private void takeEffect(boolean animate) {
        if (animate) {
            ...
            setEndAngle(calcAngle(actualState));
